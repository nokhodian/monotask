...
```bash
npx monobrain@latest swarm init --topology hierarchical --max-agents 6
```
...
# Initialize
npx monobrain@latest swarm init --topology hierarchical --max-agents 4
