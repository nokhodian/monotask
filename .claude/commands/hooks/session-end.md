...
```bash
npx monobrain hook session-end -s "quick-fix" --save-state false --cleanup-temp
```

### Complete persistence

```bash
npx monobrain hook session-end -s "major-refactor" --save-state --export-metrics --generate-summary
```
...
```bash
# At session end
npx monobrain hook session-end --session-id "your-session" --generate-summary
```
